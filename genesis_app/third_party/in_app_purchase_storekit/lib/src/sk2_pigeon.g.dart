...
class SK2SubscriptionOfferMessage {
  ...
  @override
  String toString() {
    return 'SK2SubscriptionOfferMessage(id: $id, price: $price, type: $type, period: $period, periodCount: $periodCount, paymentMode: $paymentMode)';
  }
}
...
class SK2SubscriptionPeriodMessage {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(value, other.value) && _deepEquals(unit, other.unit);
  }
  ...
  @override
  String toString() {
    return 'SK2SubscriptionPeriodMessage(value: $value, unit: $unit)';
  }
}
...
class SK2ProductMessage {
  ...
  @override
  String toString() {
    return 'SK2ProductMessage(id: $id, displayName: $displayName, localizedDescription: $localizedDescription, price: $price, displayPrice: $displayPrice, type: $type, subscription: $subscription, priceLocale: $priceLocale)';
  }
}
...
class SK2SubscriptionOfferSignatureMessage {
  ...
  @override
  String toString() {
    return 'SK2SubscriptionOfferSignatureMessage(keyID: $keyID, nonce: $nonce, timestamp: $timestamp, signature: $signature)';
  }
}
...
class SK2SubscriptionOfferPurchaseMessage {
  ...
  @override
  String toString() {
    return 'SK2SubscriptionOfferPurchaseMessage(promotionalOfferId: $promotionalOfferId, promotionalOfferSignature: $promotionalOfferSignature)';
  }
}
...
class SK2ErrorMessage {
  ...
  @override
  String toString() {
    return 'SK2ErrorMessage(code: $code, domain: $domain, userInfo: $userInfo)';
  }
}
